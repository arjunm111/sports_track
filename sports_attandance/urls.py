...
urlpatterns = [
    ...
    path('teacher/create/', views.teacher_create, name='teacher_create'),  # Create a new teacher
    path('teacher/edit/<int:teacher_id>/', views.teacher_edit, name='teacher_edit'),  # Edit a teacher
    path('teacher/delete/<int:teacher_id>/', views.teacher_delete, name='teacher_delete'),  # Delete a teacher
    path('tutors/', views.tutor_list, name='tutor_list'),  # List all tutors
    path('tutor/create/', views.tutor_create, name='tutor_create'),  # Create a new tutor
    path('tutor/edit/<int:tutor_id>/', views.tutor_edit, name='tutor_edit'),  # Edit a tutor
    path('tutor/delete/<int:tutor_id>/', views.tutor_delete, name='tutor_delete'),  # Delete a tutor
